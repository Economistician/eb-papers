...
only accurate, but \emph{operationally viable}. Importantly, these metrics are
evaluative diagnostics: they assess forecast readiness under assumed constraints
and cost structures, but do not prescribe how forecasts should be translated into
operational actions or control policies.
