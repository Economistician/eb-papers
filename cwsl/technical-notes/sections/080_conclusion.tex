...
frequency-based diagnostics and distributional analysis, \CWSL{} supports a
more complete assessment of forecasting system performance by highlighting
directional cost exposure under explicit assumptions.

Importantly, \CWSL{} is intended as a stable, interpretable metric for asymmetric
forecast evaluation rather than a prescriptive decision rule. Its primary role
is to inform model comparison and diagnostic analysis under fixed downstream
assumptions, serving as an input to broader planning or execution processes
