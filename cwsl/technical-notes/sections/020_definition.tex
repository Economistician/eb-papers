...
\CWSL{} is an evaluative metric that measures forecast--demand alignment under a
specified asymmetric cost structure. It does not prescribe operational actions
or decision rules, nor does minimizing \CWSL{} alone guarantee optimal execution
in systems with discrete choices, constraints, or policy considerations. Rather,
the metric is intended to compare forecasting performance in terms of expected
cost exposure given fixed downstream assumptions.
