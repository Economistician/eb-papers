...
of shortfall intervals. As a result, \UD\ should be interpreted jointly with
frequency-based measures such as \NSL, which quantify how often shortfalls occur.
