...
reliability, several limitations should guide its application. In particular,
\NSL\ is not intended to be optimized in isolation or treated as a standalone
objective; it is designed to be interpreted alongside complementary metrics
that capture error magnitude, cost, or broader operational context.
