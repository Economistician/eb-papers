...
capability rather than an artifact of parameter choice. Importantly, \(\tau\)
encodes an assumed operational tolerance for evaluation and is not a quantity to
be optimized or learned from the evaluation data itself.
