...
Importantly, grid-based sensitivity analysis is diagnostic in nature: it is not
intended to identify an optimal cost ratio, but to make dependence on cost
