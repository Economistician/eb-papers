...
\begin{itemize}
    ...
    \item With identical \NSL{}, the forecast with lower \CWSLscaled{} has the higher \FRS.
    \item With identical \CWSLscaled{}, the forecast with higher \NSL{} has the higher \FRS.
\end{itemize}
...
Because \NSL{} treats all shortfall events equally regardless of magnitude, it
encodes tolerance for the \emph{occurrence} of any service failure rather than its
severity, reflecting a risk posture oriented toward reliability rather than
cost depth.
...
\begin{itemize}
    ...
    predictable, interpretable shifts in both \NSL{} and \CWSLscaled{}, resulting in
...
\begin{itemize}
    ...
    \item \textbf{Overforecast bias} preserves \NSL{} but increases \CWSLscaled{},
