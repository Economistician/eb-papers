...
Tolerance stability is measured by the \emph{Hit Rate within Tolerance} (HR@$\tau$), which
...
lens on forecast performance. Whereas NSL, UD, and HR@$\tau$ describe the structure and
