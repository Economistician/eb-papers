...
Realized demand is fixed across both scenarios. Two competing forecasts, denoted Forecast~A
and Forecast~B, are constructed such that they achieve comparable performance according to
a symmetric accuracy metric (e.g., MAE). Under symmetric evaluation, the two forecasts would
