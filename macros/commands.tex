...
% ----------------------------------------------------------
% FAS (Forecast Admissibility Surface)
% ----------------------------------------------------------
\providecommand{\FAS}{\ensuremath{\mathrm{FAS}}}

% Admissibility classes
\providecommand{\Allowed}{\textsc{Allowed}}
\providecommand{\Conditional}{\textsc{Conditional}}
\providecommand{\Blocked}{\textsc{Blocked}}

% Slice domain + keys (for formal definitions)
\providecommand{\Domain}{\ensuremath{\mathcal{D}}}
\providecommand{\Slice}{\ensuremath{\sigma}}
\providecommand{\SliceKeys}{\ensuremath{\mathcal{K}}}
...
% RAL: adjustment grid / bounds (used in RAL note)
\providecommand{\deltavar}{\ensuremath{\delta}}
\providecommand{\deltaset}{\ensuremath{\Delta}}
\providecommand{\deltamin}{\ensuremath{\deltaset_{\min}}}
\providecommand{\deltamax}{\ensuremath{\deltaset_{\max}}}
...
% Core metrics (upright math)
% ----------------------------------------------------------
% Original: \providecommand{\CWSL}{\ensuremath{\mathrm{CWSL}}}
% Updated to accept argument for usage like \CWSL(yhat)
\providecommand{\CWSL}[1]{\ensuremath{\mathrm{CWSL}\!\left(#1\right)}}
\providecommand{\CWSLR}[1]{\ensuremath{\mathrm{CWSLR}\!\left(#1\right)}} % named artifact in prose
\providecommand{\NSL}[1][]{\ensuremath{\mathrm{NSL}}} % optional arg
\providecommand{\UD}[1][]{\ensuremath{\mathrm{UD}}} % optional arg
\providecommand{\HR}[1][]{\ensuremath{\mathrm{HR}}} % optional arg
\providecommand{\HRtau}[1][]{\ensuremath{\mathrm{HR}@\tau}} % optional arg

% FRS sub-terms
\providecommand{\CWSLscaled}[1][]{\ensuremath{\mathrm{CWSL}_{\mathrm{scaled}}}}
\providecommand{\CWSLmax}[1][]{\ensuremath{\mathrm{CWSL}_{\max}}}

% Random inserts
\providecommand{\CWSL}[1][]{%
  \ensuremath{\mathrm{CWSL}\if\relax\detokenize{#1}\relax\else\!\left(#1\right)\fi}%
}
\providecommand{\CWSLR}[1][]{%
  \ensuremath{\mathrm{CWSLR}\if\relax\detokenize{#1}\relax\else\!\left(#1\right)\fi}%
}

\providecommand{\DeltaCWSL}{\ensuremath{\Delta \CWSL}}
\providecommand{\DeltaHRtau}{\ensuremath{\Delta \HRtau}}
\providecommand{\DeltaNSL}{\ensuremath{\Delta \NSL}}
\providecommand{\DeltaCWSL}{\ensuremath{\Delta \CWSL}}
\providecommand{\UBR}{\ensuremath{\text{UBR}}}
\providecommand{\yhatadj}{\hat{y}_{\text{adj}}}
\providecommand{\CWSL}{\ensuremath{\text{CWSL}}}
\providecommand{\NSL}{\ensuremath{\text{NSL}}}
